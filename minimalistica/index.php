...
<?php
$header = 'Сайт с непонятным Испанским бредом';
$content = 'Какой-то контент';
$content2 = 'Лорен Ипсан';
$title = 'ТЕСТОВЫЙ САЙТ GEEKBRAINS';
?>
...
<body>
	<div id="content">
		...
		<div class="post">
			<div class="details">
				<h2><a href="#"><?php echo $content2; ?></a></h2>
		...
		<div id="footer">
		      <p>Copyright &copy; <em>minimalistica</em>  &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a> <em>Текущий год:<?php echo date('Y');?></em></p>
		</div>	
	</div>
</body>
</html>